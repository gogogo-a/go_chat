        ...
        <el-container class="chat-container">
          <el-header>
            ...
            <div class="chat-title-right">
              ...
              <Modal :isVisible="isMessageUserInfoModalVisible">
                <template v-slot:header>
                  <div class="userinfo-modal-quit-btn-container">
                    <button
                      class="userinfo-modal-quit-btn"
                      @click="quitMessageUserInfoModal"
                    >
                      <el-icon><Close /></el-icon>
                    </button>
                  </div>
                ...
                <template v-slot:body>
                  ...
                  >
                    ...
                    >
                      <el-image
                        style="width: 100px; height: 100px"
                        :src="backendUrl + messageUserInfo.avatar"
                      />
                    </el-descriptions-item>
                    <el-descriptions-item label="Id" :width="140">{{
                      messageUserInfo.uuid
                    }}</el-descriptions-item>
                    <el-descriptions-item label="性别">{{
                      messageUserInfo.gender == 0 ? "男" : "女"
                    }}</el-descriptions-item>
                    <el-descriptions-item label="电话号码">{{
                      messageUserInfo.telephone
                    }}</el-descriptions-item>
                    <el-descriptions-item label="昵称">{{
                      messageUserInfo.nickname
                    }}</el-descriptions-item>
                    <el-descriptions-item label="邮箱" :span="2">
                      <div style="height: 30px">
                    ...
                    <el-descriptions-item label="生日" :span="1" :width="140">{{
                      messageUserInfo.birthday
                    }}</el-descriptions-item>
                    <el-descriptions-item label="个性签名">
                      <div style="height: 70px">
                        {{ messageUserInfo.signature }}
                      </div>
                    </el-descriptions-item>
                  </el-descriptions>
                </template>
                    ...
                    <div class="left-message-left">
                      <el-image
                        ...
                        style="
                          ...
                          cursor: pointer;
                        "
                        @click="showMessageUserInfo(messageItem.send_id)"
                      >
                      </el-image>
                    </div>
          ...
          <el-footer>
            <div class="tool-bar">
              <div class="tool-bar-left">
                <el-popover placement="top-start" :width="300" trigger="click">
                  <template #reference>
                    <button class="image-button">
                      <svg t="1733502796507" class="sticker-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1555" width="128" height="128">
                        <path d="M504.32 31.872a472.256 472.256 0 1 1 0 944.512 472.256 472.256 0 0 1 0-944.512z m0 63.36a408.96 408.96 0 1 0 0 817.856 408.96 408.96 0 0 0 0-817.92z m228.864 487.808v0.192a217.856 217.856 0 1 1-435.712 0V583.04h435.712zM370.496 321.536a73.024 73.024 0 1 1 0 146.048 73.024 73.024 0 0 1 0-146.048z m289.664 0a73.024 73.024 0 1 1 0 146.048 73.024 73.024 0 0 1 0-146.048z" fill="#2c2c2c" p-id="1556"></path>
                      </svg>
                    </button>
                  </template>
                ...
                <el-tooltip effect="customized" content="文件上传" placement="top" hide-after="0" enterable="false">
                  <button class="image-button">
                    <el-upload v-model:file-list="fileList" ref="uploadRef" :auto-upload="true" :show-file-list="false" :action="uploadPath" :on-success="handleUploadSuccess" :before-upload="beforeFileUpload" style="display: flex; align-items: center; justify-content: center;">
                      <svg t="1733503065264" class="upload-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2430" width="128" height="128">
                        <path d="M543.7 157v534c0 16.6-13.4 30-30 30s-30-13.4-30-30V157c0-16.6 13.4-30 30-30 16.5 0 30 13.4 30 30z" fill="" p-id="2431"></path>
                        <path d="M323.1 331c11.8 11.8 30.7 11.8 42.5 0l119.9-119.9c15.6-15.6 40.9-15.6 56.6 0L662 331c11.7 11.7 30.7 11.7 42.4 0s11.7-30.7 0-42.4L541.7 126.1c-15.6-15.6-41-15.6-56.6 0L323 288.6c-11.6 11.8-11.6 30.7 0.1 42.4zM853.7 913h-680c-33.1 0-60-26.9-60-60V583.7c0-16.4 12.8-30.2 29.2-30.7 16.9-0.4 30.8 13.2 30.8 30v240c0 16.6 13.4 30 30 30h620c16.6 0 30-13.4 30-30V583.7c0-16.4 12.8-30.2 29.2-30.7 16.9-0.4 30.8 13.2 30.8 30v270c0 33.1-26.9 60-60 60z" fill="" p-id="2432"></path>
                      </svg>
                    </el-upload>
                  </button>
                </el-tooltip>
                <el-tooltip effect="customized" content="聊天记录" placement="top" hide-after="0" enterable="false">
                  <button class="image-button">
                    <svg t="1733504061769" class="record-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5492" width="128" height="128">
                      <path d="M695.04 194.32H98.08c-18.32 0-33.16-14.85-33.16-33.16 0-18.32 14.85-33.16 33.16-33.16h596.96c18.32 0 33.16 14.85 33.16 33.16 0 18.31-14.84 33.16-33.16 33.16z" p-id="5493"></path>
                    </svg>
                  </button>
                </el-tooltip>
                <el-tooltip effect="customized" content="全文复制" placement="top" hide-after="0" enterable="false">
                  <button class="image-button">
                    <svg t="1733503137487" class="copy-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3442" width="128" height="128">
                      <path d="M394.666667 106.666667h448a74.666667 74.666667 0 0 1 74.666666 74.666666v448a74.666667 74.666667 0 0 1-74.666666 74.666667H394.666667a74.666667 74.666667 0 0 1-74.666667-74.666667V181.333333a74.666667 74.666667 0 0 1 74.666667-74.666666z m0 64a10.666667 10.666667 0 0 0-10.666667 10.666666v448a10.666667 10.666667 0 0 0 10.666667 10.666667h448a10.666667 10.666667 0 0 0 10.666666-10.666667V181.333333a10.666667 10.666667 0 0 0-10.666666-10.666666H394.666667z" fill="#000000" p-id="3443"></path>
                    </svg>
                  </button>
                </el-tooltip>
              </div>
              <div class="tool-bar-right">
                <el-tooltip effect="customized" content="音视频通话" placement="top" hide-after="0" enterable="false">
                  <button class="image-button" @click="showAVContainerModal">
                    <svg t="1733503700535" class="av-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4492" width="128" height="128">
                      <path d="M790.207709 1023.317561c-100.48917-0.05687-302.832389-33.89448-528.321671-260.00933C-57.722981 442.903032-9.212929 154.458736 25.02277 119.995557L114.194824 30.709763c19.506387-19.563257 47.372654-30.709763 76.319449-30.709763 28.662446 0 56.073753 10.975897 75.23892 30.141064l3.980896 4.606465 131.881373 176.865489c35.145618 52.377208 33.32578 108.564701-4.720205 146.781295l-39.012773 39.069643c11.942686 71.087415 42.31123 113.398645 87.181606 158.439632l5.686993 5.686993c51.865378 52.092858 96.678885 97.076974 174.021993 103.730756l38.899033-38.955903a99.522381 99.522381 0 0 1 71.883595-30.368544c24.169721 0 49.419971 8.41675 73.020993 24.340331l178.002888 133.303121c21.212485 14.558703 34.918138 38.728424 37.477285 66.253471a113.853604 113.853604 0 0 1-33.26891 89.513274l-89.058314 89.285793c-22.179274 22.236144-85.304898 24.624681-111.465068 24.624681h-0.056869z" fill="#666666" p-id="4493"></path>
                    </svg>
                  </button>
                </el-tooltip>
              </div>
            ...
            <div class="video-modal-overlay" v-show="isAVContainerModalVisible">
              <div class="video-modal-content">
                <div class="video-modal-header"><h2>聊天室</h2></div>
...
export default {
  ...
  setup() {
    ...
    const data = reactive({
      ...
      ICE_CFG: {
        iceServers: [
          {
            // 基础打洞服务
            urls: "stun:8.140.245.242:3478"
          },
          {
            // 中转服务
            urls: "turn:8.140.245.242:3478",
            username: "root",
            credential: "genghao123"
          }
        ]
      },
      localStream: null,
      ...
      isMessageUserInfoModalVisible: false,
      messageUserInfo: {
        uuid: "",
        nickname: "",
        avatar: "",
    ...
    const showMessageUserInfo = async (userId) => {
      try {
        const req = { uuid: userId };
        const rsp = await axios.post(
          store.state.backendUrl + "/user/getUserInfo",
          req
        );
        if (rsp.data.code == 200) {
          data.messageUserInfo = rsp.data.data;
          data.isMessageUserInfoModalVisible = true;
        } else {
    ...
    const quitMessageUserInfoModal = () => {
      data.isMessageUserInfoModalVisible = false;
    };
